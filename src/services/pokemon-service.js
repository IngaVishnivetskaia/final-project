export default class PokemonService {
  ...
  // РАБОТАЕТ с hardcode data:
  // getPokemons() {
  //   return this.data;

  // }

//  НЕ РАБОТАЕТ: _url = 'http://localhost:3000/pokemons/';
//   // _imageBase = 'https://starwars-visualguide.com/assets/img';

//   getPokemons = async (_url) => {
//     const res = await fetch(`${this._url}`);

//     if (!res.ok) {
//       throw new Error(`Could not fetch ${_url}` +
//         `, received ${res.status}`)
//     }
...
// }
  ...
  // let res =  fetch('http://localhost:3000/pokemons')
...
//     getAllPokemons = async () => {
//       const res = await this.getPokemons();
//       console.log(`result getallpokemons${typeof(res)}`);
//       return res;
//     };
...
// }
  ...
  // _url = 'https://run.mocky.io/v3/53a42571-cf4f-49b2-ad4a-3dc65c0630f7';
  //   getPokemons = async (_url) => {
